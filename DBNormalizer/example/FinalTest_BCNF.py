# -*- coding: utf-8 -*-
# 示例：连接真实数据库(PostgreSQL)，对库中每张表：挖掘 FD -> 求最小覆盖 -> 求候选键 -> 生成 BCNF 分解。
# 依赖本地 PostgreSQL 库 dbnormalizer_test，需要自行调整连接串。
# 运行方式：python -m DBNormalizer.example.FinalTest_BCNF
__author__ = 'Paris'
...
for i in range(0,len(names)):
    ...
    L=D.proposalBCNF(rltn,minFds)                   # BCNF 分解提议
    # for l in L:
    #    print(l[0])
    #    print(l[1])
    #    print("\n")
